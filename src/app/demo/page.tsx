...
import { DiffReport, TailoredCv } from "@/lib/types";
 ...
 * keys. Safe to keep: it touches no user data. Remove before launch if
 * you don't want a public showcase page.
 */

const demoCv: TailoredCv = {
  contact: {
    fullName: "Dana Cohen",
